...
#### Типы кэшей в ZFS
**L2ARC** -- кэш-устройство, предназначенное для повышения производительности чтения в пуле. Этот кэш заполняется со временем и хранит данные на основе комбинации, какие блоки наиболее часто используются и используются в последнее время, что обеспечивает быстрый доступ к «горячим» данным.  
