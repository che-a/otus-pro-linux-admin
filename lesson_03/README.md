...
В этой части домашнего задания (&laquo;поставить btrfs/zfs - с кешем, снапшотами - разметить здесь каталог `/opt` &raquo;) рассматривается установка и использование OpenZFS.
