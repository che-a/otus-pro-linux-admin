...
sudo ./zfs.sh
```
Процесс развертывания тестового окружения включает в себя обновление системы, установку ZFS, создание пула и файловой системы ZFS, что требует некоторого времени, включая две перезагрузки.  
Некоторая избыточность кода и описания в этом `README.md` обусловлены моим дальнейшим продолжением исследований использования стека ZFS.  
